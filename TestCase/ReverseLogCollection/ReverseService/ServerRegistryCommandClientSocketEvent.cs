...
namespace AutoCSer.TestCase.LogCollectionReverseService
{
    ...
    internal sealed class ServerRegistryCommandClientSocketEvent : AutoCSer.CommandService.StreamPersistenceMemoryDatabase.ServerRegistryCommandClientSocketEvent<ServerRegistryCommandClientSocketEvent>, AutoCSer.CommandService.IStreamPersistenceMemoryDatabaseClientSocketEvent
    {
        ...
        public ServerRegistryCommandClientSocketEvent(AutoCSer.Net.CommandClient client) : base(client) { }
        /// <summary>
        ...
        /// 日志流持久化内存数据库客户端单例
        /// </summary>
        public static readonly AutoCSer.CommandService.StreamPersistenceMemoryDatabaseClientCache<ServerRegistryCommandClientSocketEvent> StreamPersistenceMemoryDatabaseClientCache = new AutoCSer.CommandService.StreamPersistenceMemoryDatabaseClientCache<ServerRegistryCommandClientSocketEvent>(new AutoCSer.Net.CommandClientConfig
        {
