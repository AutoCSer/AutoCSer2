...
namespace AutoCSer.TestCase.BusinessService
{
    ...
    public partial interface ICustomColumnFieldModelService : IPrimaryKeyService<CustomColumnFieldModel, AutoCSer.TestCase.CommonModel.TableModel.CustomColumnFieldModel, AutoCSer.TestCase.CommonModel.TableModel.CustomColumn.CustomColumnFieldPrimaryKey>
    {
        /// <summary>
        /// 自定义列查询测试
        /// </summary>
