...
namespace AutoCSer.TestCase.StreamPersistenceMemoryDatabase.Client.MessageNode
{
    ...
    internal sealed class ServerByteArrayMessageConsumer : AutoCSer.CommandService.StreamPersistenceMemoryDatabase.ServerByteArrayMessageConsumer
    {
        ...
        {
            lock (messageLock) messages.Remove(message.AutoCSerExtensions<byte[]>().NotNull()[0]);
