...
namespace AutoCSer.TestCase.StreamPersistenceMemoryDatabaseClient
{
    internal static class LeftArrayNode
    {
        ...
        {
            ResponseResult<ILeftArrayNodeClientNode<string>> node = await client.GetOrCreateLeftArrayNode<string>(typeof(ILeftArrayNodeClientNode<string>).FullName, 0);
            ...
            ResponseResult<bool> boolResult = await node.Value.TryAdd(TestClass.String1);
