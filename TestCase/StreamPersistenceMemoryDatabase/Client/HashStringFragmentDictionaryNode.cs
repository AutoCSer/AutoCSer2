...
namespace AutoCSer.TestCase.StreamPersistenceMemoryDatabaseClient
{
    internal static class HashStringFragmentDictionaryNode
    {
        ...
        {
            ResponseResult<IHashStringFragmentDictionaryNodeClientNode<string>> node = await client.GetOrCreateFragmentHashStringDictionaryNode(typeof(IHashStringFragmentDictionaryNodeClientNode<string>).FullName);
