...
{
    internal class ServerBinaryMessageConsumer : LocalServiceServerBinaryMessageConsumer<TestClass>
    {
        internal ServerBinaryMessageConsumer(LocalClient client, IMessageNodeLocalClientNode<ServerBinaryMessage<TestClass>> node) : base(client, node) { }
        ...
        internal static async Task Test(LocalClient<ICustomServiceNodeLocalClientNode> client)
        {
            ...
            isCompleted = false;
            using (ServerBinaryMessageConsumer consumer = new ServerBinaryMessageConsumer(client, node.Value))
            {
