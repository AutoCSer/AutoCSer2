...
namespace AutoCSer.TestCase.StreamPersistenceMemoryDatabaseLocalService
{
    internal static class LeftArrayNode
    {
        ...
        {
            ResponseResult<ILeftArrayNodeLocalClientNode<string>> node = await client.GetOrCreateNode<ILeftArrayNodeLocalClientNode<string>, int>(typeof(ILeftArrayNodeLocalClientNode<string>).FullName, 0, client.ClientNode.CreateLeftArrayNode);
