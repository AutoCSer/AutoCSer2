...
namespace AutoCSer.TestCase.CommandClientPerformance
{
    ...
    internal sealed class CallbackClientPerformance : AutoCSer.TestCase.Common.ClientPerformance
    {
        ...
        {
            CommandClientConfig<ICallbackClient> commandClientConfig = AutoCSer.TestCase.Common.JsonFileConfig.Default.IsCompressConfig
                ? new CommandClientCompressConfig<ICallbackClient> { Host = AutoCSer.TestCase.Common.JsonFileConfig.Default.GetClientHostEndPoint(Common.CommandServerPortEnum.Performance), CheckSeconds = 0 }
                : new CommandClientConfig<ICallbackClient> { Host = AutoCSer.TestCase.Common.JsonFileConfig.Default.GetClientHostEndPoint(Common.CommandServerPortEnum.Performance), CheckSeconds = 0 };
            ...
            {
                CommandClientSocketEvent<ICallbackClient> client = await commandClient.GetSocketEvent<CommandClientSocketEvent<ICallbackClient>>();
                if (client == null)
                {
