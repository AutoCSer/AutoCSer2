...
namespace AutoCSer.TestCase.DeployTask
{
        ...
        ///  客户端节点接口
        /// </summary>
        [AutoCSer.CommandService.StreamPersistenceMemoryDatabase.ClientNode(typeof(AutoCSer.TestCase.DeployTask.ICustomServiceNode))]
