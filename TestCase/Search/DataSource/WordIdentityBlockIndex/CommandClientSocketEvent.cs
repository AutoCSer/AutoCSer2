...
using AutoCSer.TestCase.SearchWordIdentityBlockIndex;
using System;
...
namespace AutoCSer.TestCase.WordIdentityBlockIndex
{
    ...
    internal sealed class CommandClientSocketEvent : AutoCSer.Net.CommandClientSocketEventTask<CommandClientSocketEvent>, IStreamPersistenceMemoryDatabaseClientSocketEvent
    {
        ...
        /// 日志流持久化内存数据库客户端单例
        /// </summary>
        public static readonly AutoCSer.CommandService.StreamPersistenceMemoryDatabaseClientCache<AutoCSer.TestCase.SearchWordIdentityBlockIndex.IServiceNodeClientNode, CommandClientSocketEvent> StreamPersistenceMemoryDatabaseClientCache = new AutoCSer.CommandService.StreamPersistenceMemoryDatabaseClientCache<AutoCSer.TestCase.SearchWordIdentityBlockIndex.IServiceNodeClientNode, CommandClientSocketEvent>(CommandClient);
        /// <summary>
        /// 用户名称分词结果磁盘块索引信息节点单例
        /// </summary>
