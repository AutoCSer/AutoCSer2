...
namespace AutoCSer.TestCase.SearchQueryService
{
    class Program
    {
        ...
        private static async Task trieGraphNode()
        {
            ...
            LocalResult<IStaticTrieGraphNodeLocalClientNode> trieGraphNode = await MemoryTrieGraphServiceConfig.StaticTrieGraphNodeCache.GetSynchronousNode();
        ...
        private static async Task searchUserNodeCache()
        {
            ...
            LocalResult<ISearchUserNodeLocalClientNode> searchUserNodeCache = await MemorySearchUserServiceConfig.SearchUserNodeCache.GetNode();
        ...
        private static async Task userNameIndexNode()
        {
            ...
            LocalResult<IHashCodeKeyIndexNodeLocalClientNode<int>> userNameIndexNode = await MemorySearchUserServiceConfig.UserNameNodeCache.GetNode();
        ...
        private static async Task userRemarkIndexNode()
        {
            ...
            LocalResult<IHashCodeKeyIndexNodeLocalClientNode<int>> userRemarkIndexNode = await MemorySearchUserServiceConfig.UserRemarkNodeCache.GetNode();
        ...
        private static async Task userNameWordIdentityNode()
        {
            ...
            LocalResult<AutoCSer.CommandService.Search.WordIdentityBlockIndex.ILocalNodeLocalClientNode<int>> userNameWordIdentityNode = await MemoryWordIdentityBlockIndexServiceConfig.UserNameNodeCache.GetNode();
        ...
        private static async Task userRemarkWordIdentityNode()
        {
            ...
            LocalResult<AutoCSer.CommandService.Search.WordIdentityBlockIndex.ILocalNodeLocalClientNode<int>> userRemarkWordIdentityNode = await MemoryWordIdentityBlockIndexServiceConfig.UserRemarkNodeCache.GetNode();
