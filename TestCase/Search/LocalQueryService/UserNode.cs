...
namespace AutoCSer.TestCase.SearchQueryService
{
    ...
    internal abstract class UserNode : AutoCSer.CommandService.Search.WordIdentityBlockIndex.LocalNode<int>
    {
        ...
        /// 带移除标记的可重用哈希索引节点
        /// </summary>
        protected readonly StreamPersistenceMemoryDatabaseLocalClientNodeCache<IRemoveMarkHashKeyIndexNodeLocalClientNode<int>> diskBlockIndexNode;
        /// <summary>
        /// 用户信息分词结果磁盘块索引信息节点
        /// </summary>
        /// <param name="loadClientNode"></param>
        /// <param name="diskBlockIndexNode"></param>
        internal UserNode(StreamPersistenceMemoryDatabaseLocalClientNodeCache<AutoCSer.CommandService.Search.WordIdentityBlockIndex.ILocalNodeLocalClientNode<int>> loadClientNode, StreamPersistenceMemoryDatabaseLocalClientNodeCache<IRemoveMarkHashKeyIndexNodeLocalClientNode<int>> diskBlockIndexNode)
            : base(LocalTrieGraphServiceConfig.StaticTrieGraphNodeCache, loadClientNode)
        {
        ...
        {
            LocalResult<IRemoveMarkHashKeyIndexNodeLocalClientNode<int>> node = await diskBlockIndexNode.GetSynchronousNode();
