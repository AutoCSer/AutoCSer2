...
namespace AutoCSer.TestCase.SearchQueryService
{
    ...
    /// 用户搜索非索引条件数据节点配置
    /// </summary>
    internal sealed class LocalSearchUserServiceConfig : LocalServiceConfig
    {
        /// <summary>
        ...
        /// 日志流持久化内存数据库本地服务
        /// </summary>
        private static readonly LocalService localService = new LocalSearchUserServiceConfig
        {
