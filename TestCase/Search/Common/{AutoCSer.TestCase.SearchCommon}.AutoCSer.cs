...
{
        /// <summary>
        /// 用户搜索数据更新消息节点的自定义基础服务接口 client node interface
        /// </summary>
...
{
        /// <summary>
        /// 创建分词结果磁盘块索引信息节点的自定义基础服务接口 client node interface
        /// </summary>
...
}namespace AutoCSer.TestCase.SearchWordIdentityBlockIndex
{
        ...
        /// <summary>
        /// 创建分词结果磁盘块索引信息节点的自定义基础服务接口 (Node method sequence number mapping enumeration type)
        /// </summary>
