...
var AutoCSer;
(function (AutoCSer) {
    var FloatCenter = /** @class */ (function () {
        function FloatCenter(Parameter) {
            ...
            if (this.ViewData)
                this.View = AutoCSer.View.Views[this.Id] || new AutoCSer.View(this.Id);
        ...
        FloatCenter.prototype.Show = function () {
            ...
            if (AutoCSer.Pub.IsFixed) {
                ...
                if (this.AutoClass) {
                    if (this.View)
                        this.View.SetHtml(this.ViewData);
        ...
        FloatCenter.DefaultParameter = { Id: null, IsFixed: false, IsEsc: true, Timeout: 200, ViewData: null, ZIndex: 0, AutoClass: null };
        return FloatCenter;
    }());
