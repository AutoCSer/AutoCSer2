...
(function (AutoCSer) {
    var OverIframe = /** @class */ (function () {
        function OverIframe(Parameter) {
            ...
            var Identity = AutoCSer.Pub.GetIdentity();
        ...
        OverIframe.DefaultParameter = { WaitingImage: null, IframePath: null, IframeCode: null, Width: null, Height: null };
        return OverIframe;
    }());
    AutoCSer.OverIframe = OverIframe;
    AutoCSer.Pub.OnLoad(OverIframe.CreateDefault, OverIframe, true);
})(AutoCSer || (AutoCSer = {}));
//# sourceMappingURL=overIframe.js.map