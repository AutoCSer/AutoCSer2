...
///            发布任务节点接口 client node interface
        /// </summary>
...
///            发布任务节点接口
        ...
        /// <summary>
        /// The interface of the deploy task node 
///            发布任务节点接口 (Node method sequence number mapping enumeration type)
        /// </summary>
...
///            任务标识ID
            /// AutoCSer.CommandService.DeployTask.StepTaskData task The task of executing a program 
///            执行程序任务
            ...
            /// [1] Create a task 
///            创建任务
            /// 返回值 long Task identity 
///            任务标识ID
            /// </summary>
            Create = 1,
            /// <summary>
            /// [2] Get the callback log of the status change of the published task 
///            获取发布任务状态变更回调日志
            /// long identity Task identity 
///            任务标识ID
            /// </summary>
            GetLog = 2,
            /// <summary>
            /// [3] Remove completed or un-started task 
///            移除已结束或者未开始任务
            /// long identity Task identity 
///            任务标识ID
            /// System.DateTime closeTime The Utc time for closing the task 
///            关闭任务 Utc 时间
            /// 返回值 AutoCSer.CommandService.DeployTask.OperationStateEnum 
            /// </summary>
            Remove = 3,
            /// <summary>
            /// [4] Remove completed or un-started task (Initialize and load the persistent data) 
...
///            加载快照数据（从快照数据恢复内存数据）
            /// AutoCSer.CommandService.DeployTask.TaskData value data
            /// </summary>
            SnapshotSet = 5,
            /// <summary>
            /// [6] Start the task 
///            启动任务
            /// long identity Task identity 
///            任务标识ID
            /// System.DateTime startTime The Utc time for running the task 
///            运行任务 Utc 时间
            /// 返回值 AutoCSer.CommandService.DeployTask.OperationStateEnum 
            /// </summary>
            Start = 6,
            /// <summary>
            /// [7] Start the task (Initialize and load the persistent data) 
///            启动任务（初始化加载持久化数据）
            /// long identity Task identity 
///            任务标识ID
            /// System.DateTime startTime The Utc time for running the task 
