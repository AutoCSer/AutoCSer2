...
namespace AutoCSer.CommandService
{
    ...
    public class DistributedLockService<T> : DistributedLockController, IDistributedLockService<T> where T : IEquatable<T>
    {
        ...
        public DistributedLockService(DistributedMillisecondIdentityGenerator identityGenerator = null, IDistributedLockManager<T> manager = null) : base(identityGenerator)
        {
        ...
        /// <param name="requestID">锁请求标识</param>
        /// <returns></returns>
        CommandServerSendOnly IDistributedLockService<T>.TryKeep(CommandServerSocket socket, CommandServerCallQueue queue, T key, long requestID)
        {
