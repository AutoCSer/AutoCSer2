...
namespace AutoCSer.CommandService
{
    ...
    [AutoCSer.Net.CommandServerControllerInterface(MethodIndexEnumType = typeof(TimestampVerifyReverseServiceMethodEnum), MethodIndexEnumTypeCodeGeneratorPath = "", IsAutoMethodIndex = false)]
