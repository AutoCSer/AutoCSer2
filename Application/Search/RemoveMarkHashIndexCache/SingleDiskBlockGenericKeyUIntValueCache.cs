...
namespace AutoCSer.CommandService.Search.RemoveMarkHashIndexCache
{
    ...
    public sealed class SingleDiskBlockGenericKeyUIntValueCache<KT> : GenericKeyUIntValueCache<KT>
#if NetStandard21
...
#endif
    {
        ...
        public SingleDiskBlockGenericKeyUIntValueCache(IDiskBlockClientSocketEvent diskBlockClient, StreamPersistenceMemoryDatabaseClientNodeCache<IRemoveMarkHashKeyIndexNodeClientNode<KT>> node, long maxCount, int capacity = 1 << 16) : base(node, maxCount, capacity)
        {
