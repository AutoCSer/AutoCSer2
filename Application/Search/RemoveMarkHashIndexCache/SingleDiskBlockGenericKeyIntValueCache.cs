...
namespace AutoCSer.CommandService.Search.RemoveMarkHashIndexCache
{
    ...
    public sealed class SingleDiskBlockGenericKeyIntValueCache<KT, NT> : GenericKeyIntValueCache<KT, NT>
#if NetStandard21
...
#endif
    {
        ...
        public SingleDiskBlockGenericKeyIntValueCache(IDiskBlockClientSocketEvent diskBlockClient, StreamPersistenceMemoryDatabaseClientNodeCache<IRemoveMarkHashKeyIndexNodeClientNode<KT>> node, long maxCount, int capacity = 1 << 16) : base(node, maxCount, capacity)
        {
