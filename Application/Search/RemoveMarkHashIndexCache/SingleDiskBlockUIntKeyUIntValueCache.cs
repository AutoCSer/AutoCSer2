...
namespace AutoCSer.CommandService.Search.RemoveMarkHashIndexCache
{
    ...
    /// </summary>
    public sealed class SingleDiskBlockUIntKeyUIntValueCache : UIntKeyUIntValueCache
    {
        /// <summary>
        /// 数据关键字磁盘块索引信息客户端
        /// </summary>
        ...
        public SingleDiskBlockUIntKeyUIntValueCache(IDiskBlockClientSocketEvent diskBlockClient, StreamPersistenceMemoryDatabaseClientNodeCache<IRemoveMarkHashKeyIndexNodeClientNode<uint>> node, long maxCount, int capacity = 1 << 16) : base(node, maxCount, capacity)
        {
