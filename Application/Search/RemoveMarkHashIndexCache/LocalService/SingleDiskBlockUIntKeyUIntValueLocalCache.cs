...
namespace AutoCSer.CommandService.Search.RemoveMarkHashIndexCache
{
    ...
    /// </summary>
    public sealed class SingleDiskBlockUIntKeyUIntValueLocalCache : UIntKeyUIntValueLocalCache
    {
        /// <summary>
        /// 数据关键字磁盘块索引信息客户端
        /// </summary>
        ...
        /// 容器初始化大小</param>
        public SingleDiskBlockUIntKeyUIntValueLocalCache(IDiskBlockClientSocketEvent diskBlockClient, StreamPersistenceMemoryDatabaseLocalClientNodeCache<IRemoveMarkHashKeyIndexNodeLocalClientNode<uint>> node, long maxCount, int capacity = 1 << 16) : base(node, maxCount, capacity)
        {
