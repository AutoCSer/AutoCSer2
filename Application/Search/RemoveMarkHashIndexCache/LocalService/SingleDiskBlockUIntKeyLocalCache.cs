...
namespace AutoCSer.CommandService.Search.RemoveMarkHashIndexCache
{
    ...
    public sealed class SingleDiskBlockUIntKeyLocalCache<VT> : UIntKeyLocalCache<VT>
#if NetStandard21
...
#endif
    {
        ...
        /// 容器初始化大小</param>
        public SingleDiskBlockUIntKeyLocalCache(IDiskBlockClientSocketEvent diskBlockClient, StreamPersistenceMemoryDatabaseLocalClientNodeCache<IRemoveMarkHashIndexNodeLocalClientNode<uint, VT>> node, long maxCount, int capacity = 1 << 16) : base(node, maxCount, capacity)
        {
