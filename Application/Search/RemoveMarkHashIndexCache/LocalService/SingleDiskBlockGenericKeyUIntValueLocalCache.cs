...
namespace AutoCSer.CommandService.Search.RemoveMarkHashIndexCache
{
    ...
    /// 索引关键字类型</typeparam>
    public sealed class SingleDiskBlockGenericKeyUIntValueLocalCache<KT> : GenericKeyUIntValueLocalCache<KT>
#if NetStandard21
...
#endif
    {
        ...
        /// 容器初始化大小</param>
        public SingleDiskBlockGenericKeyUIntValueLocalCache(IDiskBlockClientSocketEvent diskBlockClient, StreamPersistenceMemoryDatabaseLocalClientNodeCache<IRemoveMarkHashKeyIndexNodeLocalClientNode<KT>> node, long maxCount, int capacity = 1 << 16) : base(node, maxCount, capacity)
        {
