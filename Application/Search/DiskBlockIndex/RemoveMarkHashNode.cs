...
namespace AutoCSer.CommandService.Search.DiskBlockIndex
{
    ...
    internal struct RemoveMarkHashNode
    {
        ...
        {
            indexData = ((uint)source << 20) | RemoveMarkHashSetCapacity.MaxCapacity;
            HashCode = hashCode;
        }
        /// <summary>
        /// 设置数据
        ...
        {
            indexData = ((uint)source << 20) | (RemoveMarkHashSetCapacity.MaxCapacity | 0x40000000U);
            HashCode = hashCode;
        }
        /// <summary>
        /// 设置数据
        ...
        {
            indexData = ((uint)source << 20) | (RemoveMarkHashSetCapacity.MaxCapacity | 0x80000000U);
            HashCode = hashCode;
        }
        /// <summary>
        /// 设置数据
        ...
        {
            indexData = ((uint)source << 20) | (RemoveMarkHashSetCapacity.MaxCapacity | 0xc0000000U);
            HashCode = hashCode;
        }
    }
    /// <summary>
