...
namespace AutoCSer.CommandService.Search
{
    ...
    public sealed class WordIdentityBlockIndexData<T>
#if NetStandard21
...
#endif
    {
        ...
        /// 分词结果磁盘块索引信息
        /// </summary>
        internal WordIdentityBlockIndexData()
        {
        ...
        internal WordIdentityBlockIndexData(BlockIndex blockIndex)
        {
        ...
        /// <returns></returns>
#if NetStandard21
        internal async Task Create(WordIdentityBlockIndexNode<T> node, T key, MethodCallback<WordIdentityBlockIndexUpdateStateEnum> callback, string? text = null)
#else
        internal async Task Create(WordIdentityBlockIndexNode<T> node, T key, MethodCallback<WordIdentityBlockIndexUpdateStateEnum> callback, string text = null)
#endif
        {
        ...
        /// <returns></returns>
        internal async Task Completed(WordIdentityBlockIndexNode<T> node, T key, BlockIndex blockIndex)
        {
