...
namespace AutoCSer.CommandService.Search.WordIdentityBlockIndex
{
    ...
    internal sealed class LocalLoadCallback<T> : ReadWriteQueueNode
#if NetStandard21
...
#endif
    {
        ...
        /// 分词结果磁盘块索引信息节点
        /// </summary>
        private readonly LocalNode<T> node;
        /// <summary>
        /// 创建分词结果磁盘块索引信息返回参数集合
        /// </summary>
        internal readonly LocalServiceQueueNode<LocalResult<WordIdentityBlockIndexUpdateStateEnum>>[] CreateResponses;
        /// <summary>
        /// 分词数据集合
        /// </summary>
        ...
        internal LocalLoadCallback(LocalNode<T> node, BinarySerializeKeyValue<T, string>[] values)
        {
            this.node = node;
            Values = values;
            CreateResponses = new LocalServiceQueueNode<LocalResult<WordIdentityBlockIndexUpdateStateEnum>>[values.Length];
