...
namespace AutoCSer.CommandService.StreamPersistenceMemoryDatabase
{
        ...
        where CT : class, IServiceNodeLocalClientNode
    {
        ...
        /// <returns>节点标识，已经存在节点则直接返回</returns>
        [MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        public Task<LocalResult<IHashSetNodeLocalClientNode<KT>>> GetOrCreateHashSetNode<KT>(string key, int capacity = 0, bool isPersistenceCallbackExceptionRenewNode = false)
            where KT : IEquatable<KT>
        {
            return GetOrCreateNode<IHashSetNodeLocalClientNode<KT>>(key, (index, nodeKey, nodeInfo) => ClientNode.CreateHashSetNode(index, nodeKey, nodeInfo, typeof(KT), capacity), isPersistenceCallbackExceptionRenewNode);
        }
        /// <summary>
