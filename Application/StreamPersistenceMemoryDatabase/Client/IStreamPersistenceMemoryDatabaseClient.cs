...
namespace AutoCSer.CommandService
{
    ...
    public interface IStreamPersistenceMemoryDatabaseClient
    {
        ...
        /// <returns></returns>
        KeepCallbackCommand TwoStageCallback(KeepCallbackResponseParameter returnValue, NodeIndex index, int methodIndex, CommandClientReturnValueParameterCallback<ResponseParameter> callback, Action<CommandClientReturnValue<KeepCallbackResponseParameter>, KeepCallbackCommand> keepCallback);
        /// <summary>
        /// Call the node method (client I/O thread synchronization callback)
        /// 调用节点方法（客户端 IO 线程同步回调）
        /// </summary>
        ...
        /// <param name="keepCallback"></param>
        /// <returns></returns>
        KeepCallbackCommand InputTwoStageCallback(KeepCallbackResponseParameter returnValue, RequestParameter parameter, CommandClientReturnValueParameterCallback<ResponseParameter> callback, Action<CommandClientReturnValue<KeepCallbackResponseParameter>, KeepCallbackCommand> keepCallback);
        /// <summary>
        /// Call the node method
        /// 调用节点方法
        /// </summary>
        ...
        /// <param name="keepCallback"></param>
        /// <returns></returns>
        KeepCallbackCommand TwoStageCallbackWrite(KeepCallbackResponseParameter returnValue, NodeIndex index, int methodIndex, CommandClientReturnValueParameterCallback<ResponseParameter> callback, Action<CommandClientReturnValue<KeepCallbackResponseParameter>, KeepCallbackCommand> keepCallback);
        /// <summary>
        /// Call the node method (client I/O thread synchronization callback)
        /// 调用节点方法（客户端 IO 线程同步回调）
        /// </summary>
        ...
        /// <param name="keepCallback"></param>
        /// <returns></returns>
        KeepCallbackCommand InputTwoStageCallbackWrite(KeepCallbackResponseParameter returnValue, RequestParameter parameter, CommandClientReturnValueParameterCallback<ResponseParameter> callback, Action<CommandClientReturnValue<KeepCallbackResponseParameter>, KeepCallbackCommand> keepCallback);
        /// <summary>
