...
{
        /// <summary>
        /// 超时任务消息节点接口（用于分布式事务数据一致性检查） 本地客户端节点接口
        /// </summary>
        [AutoCSer.CommandService.StreamPersistenceMemoryDatabase.ClientNode(typeof(AutoCSer.CommandService.StreamPersistenceMemoryDatabase.CustomNode.ITimeoutMessageNode<>))]
