...
namespace AutoCSer.CommandService.StreamPersistenceMemoryDatabase
{
    ...
    /// 用于 await
    /// </summary>
    public sealed class ResponseReturnValue : INotifyCompletion
    {
        /// <summary>
        /// Return parameter
        /// 返回参数
        /// </summary>
        public readonly ResponseResultAwaiter Response;
        /// <summary>
        ...
        /// 调用状态
        /// </summary>
        public CallStateEnum State { get { return Response.Command.ReturnValue; } }
        /// <summary>
        ...
        /// 用于 await
        /// </summary>
        /// <param name="response">Return parameter
        /// 返回参数</param>
        /// <param name="isIgnoreError">Whether errors and exceptions are ignored
        /// 是否忽略错误与异常</param>
        internal ResponseReturnValue(ResponseResultAwaiter response, bool isIgnoreError)
        {
            Response = response;
...
#endif
        {
            Response.GetResult().GetValue(isIgnoreError);
        }
        /// <summary>
        ...
        /// <returns></returns>
        [MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        public ResponseReturnValue GetAwaiter()
        {
            return this;
        }
    }
...
#endif
        {
            return Response.GetResult().GetValue(isIgnoreError);
        }
        /// <summary>
        /// Get the awaiter object
        /// </summary>
