...
{
    /// <summary>
    /// 返回参数 await ResponseValueResult{T}
    /// </summary>
    /// <typeparam name="T"></typeparam>
    public sealed class BinarySerializeResponseParameterValueResultAwaiter<T> : ResponseParameter, INotifyCompletion
    {
        /// <summary>
        /// 异步回调
        /// </summary>
        ...
        /// 数据
        /// </summary>
        private ServerReturnValue<T> value;
        /// <summary>
        /// 返回参数
        /// </summary>
        internal BinarySerializeResponseParameterValueResultAwaiter() { }
        /// <summary>
        /// 反序列化
        /// </summary>
        ...
        public ResponseValueResult<T?> GetResult()
        {
            if (command.ReturnType == CommandClientReturnTypeEnum.Success)
            {
                ...
                switch (state)
                {
                    case CallStateEnum.Success: return new ResponseValueResult<T?>(value.ReturnValue);
        ...
        /// <returns></returns>
        [MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        public BinarySerializeResponseParameterValueResultAwaiter<T> GetAwaiter()
        {
            return this;
        }
    }
