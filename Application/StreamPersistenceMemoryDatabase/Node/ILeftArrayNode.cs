...
namespace AutoCSer.CommandService.StreamPersistenceMemoryDatabase
{
    ...
    public interface ILeftArrayNode<T>
    {
        ...
        bool AddBeforePersistence(T value);
        /// <summary>
        /// 添加数据
        /// </summary>
        /// <param name="value">数据</param>
        ...
        /// <param name="value">数据</param>
        /// <returns>无返回值表示需要继续调用持久化方法</returns>
        ValueResult<bool> InsertBeforePersistence(int index, T value);
        /// <summary>
        /// 插入数据
        /// </summary>
        /// <param name="index">插入位置</param>
        ...
        /// <param name="index">数据位置</param>
        /// <returns>无返回值表示需要继续调用持久化方法</returns>
        ValueResult<ValueResult<T>> GetValueRemoveAtBeforePersistence(int index);
        /// <summary>
        /// 移除指定索引位置数据并返回被移除的数据
        /// </summary>
        /// <param name="index">数据位置</param>
        ...
        /// <returns>无返回值表示需要继续调用持久化方法</returns>
        ValueResult<bool> RemoveToEndBeforePersistence(int index);
        /// <summary>
        ...
        /// <param name="index"></param>
        /// <returns>无返回值表示需要继续调用持久化方法</returns>
        ValueResult<ValueResult<T>> GetValueRemoveToEndBeforePersistence(int index);
        /// <summary>
        /// 移除指定索引位置数据，将最后一个数据移动到该指定位置，并返回被移除的数据
        /// </summary>
        /// <param name="index"></param>
        ...
        /// </summary>
        /// <returns>无返回值表示需要继续调用持久化方法</returns>
        ValueResult<ValueResult<T>> GetTryPopValueBeforePersistence();
        /// <summary>
        /// 移除最后一个数据并返回该数据
        /// </summary>
        ...
        /// </summary>
        /// <returns>无返回值表示需要继续调用持久化方法</returns>
        ValueResult<bool> TryPopBeforePersistence();
        /// <summary>
        /// 移除最后一个数据
        /// </summary>
