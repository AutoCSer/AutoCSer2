...
namespace AutoCSer.CommandService.StreamPersistenceMemoryDatabase
{
    ...
    public abstract class ServerBinaryMessageConsumer<T> : MessageConsumer<ServerBinaryMessage<T>>
    {
        /// <summary>
        ...
        protected ServerBinaryMessageConsumer(CommandClient commandClient, IMessageNodeClientNode<ServerBinaryMessage<T>> node, int delayMilliseconds = DefaultDelayMilliseconds) : base(commandClient, node, delayMilliseconds) { }
        /// <summary>
        /// 消息处理，异常则表示消息执行失败
        /// </summary>
