...
namespace AutoCSer.CommandService.StreamPersistenceMemoryDatabase
{
    ...
    public abstract class ServerByteArrayMessageStringConsumer : MessageConsumer<ServerByteArrayMessage>
    {
        ...
        protected ServerByteArrayMessageStringConsumer(CommandClient commandClient, IMessageNodeClientNode<ServerByteArrayMessage> node, int delayMilliseconds = DefaultDelayMilliseconds) : base(commandClient, node, delayMilliseconds) { }
        /// <summary>
        /// 消息处理，异常则表示消息执行失败
        /// </summary>
