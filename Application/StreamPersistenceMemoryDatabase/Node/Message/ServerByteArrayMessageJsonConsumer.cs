...
namespace AutoCSer.CommandService.StreamPersistenceMemoryDatabase
{
    ...
    public abstract class ServerByteArrayMessageJsonConsumer<T> : MessageConsumer<ServerByteArrayMessage>
    {
        ...
        protected ServerByteArrayMessageJsonConsumer(CommandClient commandClient, IMessageNodeClientNode<ServerByteArrayMessage> node, int maxMessageCount, int delayMilliseconds = DefaultDelayMilliseconds) : base(commandClient, node, maxMessageCount, delayMilliseconds) { }
        /// <summary>
