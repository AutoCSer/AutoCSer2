...
namespace AutoCSer.CommandService
{
    ...
    /// 服务注册会话对象
    /// </summary>
    public class ServiceRegisterSession : AutoCSer.Net.CommandServerCallQueueCustomNode
    {
        /// <summary>
        /// 服务注册
        /// </summary>
        ...
        public ServiceRegisterSession(ServiceRegistryService serviceRegistry, CommandServerSocket socket)
        {
            this.ServiceRegistry = serviceRegistry;
            this.socket = socket;
            SessionID = serviceRegistry.IdentityGenerator.GetNext();
        }
        /// <summary>
        /// 套接字关闭或者掉线处理
        /// </summary>
