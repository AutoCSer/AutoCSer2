...
{
    /// <summary>
    /// The server-side read and write queue continuous response API sample interface
    /// 服务端 读写队列 持续响应 API 示例接口
    /// </summary>
    public interface IKeepCallbackController
    {
        ...
        void Callback(AutoCSer.Net.CommandServerCallReadQueue queue, int left, int right, AutoCSer.Net.CommandServerKeepCallback<int> callback);
        /// <summary>
        ...
        void CallbackCount(AutoCSer.Net.CommandServerCallWriteQueue queue, int left, int right, AutoCSer.Net.CommandServerKeepCallbackCount<int> callback);
    }
    /// <summary>
    /// The server-side read and write queue continuous response API sample controller
    /// 服务端 读写队列 持续响应 API 示例控制器
    /// </summary>
