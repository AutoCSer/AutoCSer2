...
{
    /// <summary>
    /// Server-side Task asynchronous queue controller one-time response callback delegate API sample interface
    /// 服务端 Task 异步队列控制器 一次性响应 回调委托 API 示例接口
    /// </summary>
    ...
    /// <summary>
    /// Server-side Task asynchronous queue controller one-time response callback delegate API sample controller
    /// 服务端 Task 异步队列控制器 一次性响应 回调委托 API 示例控制器
    /// </summary>
