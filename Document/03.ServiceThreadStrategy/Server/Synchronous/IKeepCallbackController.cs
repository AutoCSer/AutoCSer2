...
{
    /// <summary>
    /// The server-side IO thread synchronizes and continuous response API sample interface
    /// 服务端 IO 线程同步 持续响应 API 示例接口
    /// </summary>
    ...
    /// <summary>
    /// The server-side IO thread synchronizes and continuous response API sample controller
    /// 服务端 IO 线程同步 持续响应 API 示例控制器
    /// </summary>
