...
namespace AutoCSer.Document.ServiceThreadStrategy.Client.TaskQueue
{
    ...
    {
        /// <summary>
        /// A one-time response API client queue await API example of the server-side Task asynchronous queue controller
        /// 服务端 Task 异步队列控制器 一次性响应 API 客户端队列 await API 示例
        /// </summary>
