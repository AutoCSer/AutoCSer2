...
## 1. 配置定义
[配置定义](https://github.com/AutoCSer/AutoCSer2/blob/master/Document/10.ServerRegistry/ServiceConfig.cs)操作和使用内置节点一样。
``` csharp
    /// <summary>
    /// 服务注册内存数据库服务配置
    /// </summary>
...
```
## 2. 创建服务端监听
[创建服务端监听](https://github.com/AutoCSer/AutoCSer2/blob/master/Document/10.ServerRegistry/Program.cs)操作和使用内置节点一样。
``` csharp
...
## 1. 定义注册服务 RPC 客户端实例
[定义 RPC 客户端实例](https://github.com/AutoCSer/AutoCSer2/blob/master/Document/10.ServerRegistry/MessageNodeCluster/CommandClientSocketEvent.cs)操作和使用内置节点一样。
``` csharp
    /// <summary>
    /// 注册服务 RPC 客户端实例
    /// </summary>
...
```
## 2. 创建服务注册节点客户端
[创建客户端节点](https://github.com/AutoCSer/AutoCSer2/blob/master/Document/10.ServerRegistry/MessageNodeCluster/CommandClientSocketEvent.cs)操作和使用内置节点一样。
``` csharp
        /// <summary>
        /// 日志流持久化内存数据库客户端单例
        /// </summary>
...
```
## 4. 创建消息集群服务节点
集群的服务节点必须配置相同的服务名称 [AutoCSer.Net.CommandServerConfig](https://github.com/AutoCSer/AutoCSer2/blob/master/AutoCSer/Net/CommandServer/CommandServerConfig.cs).ServerName。
``` csharp
        /// <summary>
        /// 创建服务端节点
        /// </summary>
...
# 获取服务信息
## 1. 定义注册服务 RPC 客户端实例
[定义 RPC 客户端实例](https://github.com/AutoCSer/AutoCSer2/blob/master/Document/10.ServerRegistry/MessageNodeClusterClient/ServerRegistryLogCommandClientSocketEvent.cs)操作和注册服务信息一样。
``` csharp
    /// <summary>
    /// 注册服务 RPC 客户端实例
    /// </summary>
...
```
## 2. 创建服务注册节点客户端
[创建客户端节点](https://github.com/AutoCSer/AutoCSer2/blob/master/Document/10.ServerRegistry/MessageNodeClusterClient/ServerRegistryLogCommandClientSocketEvent.cs)操作和注册服务信息一样。
``` csharp
        /// <summary>
        /// 日志流持久化内存数据库客户端单例
        /// </summary>
...
```
## 3. 定义消息集群 RPC 客户端实例
[定义消息集群 RPC 客户端实例](https://github.com/AutoCSer/AutoCSer2/blob/master/Document/10.ServerRegistry/MessageNodeClusterClient/CommandClientSocketEvent.cs)操作和使用内置节点一样。
``` csharp
    /// <summary>
    /// 消息集群 RPC 客户端实例
    /// </summary>
...
```
## 4. 定义消息客户端消费者
[定义消息消费者](https://github.com/AutoCSer/AutoCSer2/blob/master/Document/10.ServerRegistry/MessageNodeClusterClient/MessageConsumer.cs)操作和使用内置节点一样。
``` csharp
    /// <summary>
...
```
## 5. 定义消息集群客户端
[定义集群客户端示例](https://github.com/AutoCSer/AutoCSer2/blob/master/Document/10.ServerRegistry/MessageNodeClusterClient/ClusterClient.cs)派生于内置封装类型 [AutoCSer.CommandService.StreamPersistenceMemoryDatabase.ServerRegistry.ClusterClient<T>](https://github.com/AutoCSer/AutoCSer2/blob/master/Application/StreamPersistenceMemoryDatabase/Node/ServerRegistry/ClusterClient.cs)，对于复杂需求可能需要开发者自定义封装。
``` csharp
    /// <summary>
    /// 内存数据库集群客户端
    /// </summary>
...
```
# [反向 RPC 服务](https://github.com/AutoCSer/AutoCSer2/blob/master/Document/11.ReverseServer/11.ReverseServer.md)