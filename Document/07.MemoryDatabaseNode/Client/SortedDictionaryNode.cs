...
namespace AutoCSer.Document.MemoryDatabaseNode.Client
{
    ...
    internal static class SortedDictionaryNode
    {
        ...
        internal static async Task<bool> Test()
        {
            ...
            AutoCSer.CommandService.StreamPersistenceMemoryDatabase.ISortedDictionaryNodeClientNode<int, Data.TestClass> node = nodeResult.Value.AutoCSerClassGenericTypeExtensions().NotNull();
