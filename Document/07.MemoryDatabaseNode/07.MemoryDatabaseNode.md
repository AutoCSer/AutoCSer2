# 内存数据库 - 内置数据结构节点
AutoCSer 内存数据库内置支持一些简单的常用数据结构，主要包括字典、消息、分布式锁、平衡二叉树、哈希表、哈希过滤、队列、栈、位图、数组以及 AutoCSer 运维工具组件等，也可作为[自定义节点](https://github.com/AutoCSer/AutoCSer2/blob/main/Document/08.MemoryDatabaseCustomNode/08.MemoryDatabaseCustomNode.md)的参考示例。
# 服务端
