...
namespace AutoCSer.Document.MemoryDatabaseLocalService.Client
{
    ...
    internal static class SortedDictionaryNode
    {
        ...
        internal static async Task<bool> Test()
        {
            ...
            AutoCSer.CommandService.StreamPersistenceMemoryDatabase.ISortedDictionaryNodeLocalClientNode<int, Data.TestClass> node = nodeResult.Value.AutoCSerClassGenericTypeExtensions().NotNull();
