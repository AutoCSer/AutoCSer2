...
namespace AutoCSer.Document.MemoryDatabaseLocalService.Client
{
    ...
    internal static class SearchTreeDictionaryNode
    {
        ...
        internal static async Task<bool> Test()
        {
            ...
            AutoCSer.CommandService.StreamPersistenceMemoryDatabase.ISearchTreeDictionaryNodeLocalClientNode<int, Data.TestClass> node = nodeResult.Value.AutoCSerExtensions().NotNull();
