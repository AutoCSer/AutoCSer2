...
namespace AutoCSer.Document.MemoryDatabaseLocalService.Client
{
    ...
    internal static class SortedListNode
    {
        ...
        /// 客户端节点单例
        /// </summary>
        private static readonly AutoCSer.CommandService.StreamPersistenceMemoryDatabaseLocalClientNodeCache<AutoCSer.CommandService.StreamPersistenceMemoryDatabase.ISortedListNodeLocalClientNode<int, string>> nodeCache = Server.ServiceConfig.Client.CreateNode(client => client.GetOrCreateSortedListNode<int, string>(nameof(SortedListNode)));
        /// <summary>
        /// Keyword sorting array client node example
        /// 关键字排序数组客户端节点示例
        /// </summary>
        ...
        internal static async Task<bool> Test()
        {
            ...
            AutoCSer.CommandService.StreamPersistenceMemoryDatabase.ISortedListNodeLocalClientNode<int, string> node = nodeResult.Value.AutoCSerClassGenericTypeExtensions().NotNull();
