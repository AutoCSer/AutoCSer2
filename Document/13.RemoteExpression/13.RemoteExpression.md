...
```
## 4. 客户端调用
生成的客户端 API 参数类型为 System.Linq.Expressions.Expression<T>，客户端代码直接以[委托形式传参](https://github.com/AutoCSer/AutoCSer2/blob/main/Document/13.RemoteExpression/Program.cs)。
``` csharp
        /// <summary>
        /// Client-side testing
        /// </summary>
