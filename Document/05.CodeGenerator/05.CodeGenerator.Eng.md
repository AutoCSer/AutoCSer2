...
```
By default, [AutoCSer.CommandService.StreamPersistenceMemoryDatabase.ServerNodeAttribute](https://github.com/AutoCSer/AutoCSer2/blob/main/Application/StreamPersistenceMemoryDatabase/Server/ServerNodeAttribute.cs).IsReturnValueNode is set to true, indicating the generation of an API encapsulation type with the **suffix ReturnValueNode** that directly returns the required data type.
``` csharp
        /// <summary>
...
```
By default, [AutoCSer.CommandService.StreamPersistenceMemoryDatabase.ServerNodeAttribute](https://github.com/AutoCSer/AutoCSer2/blob/main/Application/StreamPersistenceMemoryDatabase/Server/ServerNodeAttribute.cs).IsReturnValueNode is set to true, indicating the generation of an API encapsulation type with the **suffix ReturnValueLocalNode** that directly returns the required data type.
``` csharp
        /// <summary>
