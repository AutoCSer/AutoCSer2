...
```
[AutoCSer.CommandService.StreamPersistenceMemoryDatabase.ServerNodeAttribute](https://github.com/AutoCSer/AutoCSer2/blob/main/Application/StreamPersistenceMemoryDatabase/Server/ServerNodeAttribute.cs).IsReturnValueNode 默认为 true 表示生成**后缀为 ReturnValueNode** 的直接返回需求数据类型的 API 封装类型。
``` csharp
        /// <summary>
...
```
[AutoCSer.CommandService.StreamPersistenceMemoryDatabase.ServerNodeAttribute](https://github.com/AutoCSer/AutoCSer2/blob/main/Application/StreamPersistenceMemoryDatabase/Server/ServerNodeAttribute.cs).IsReturnValueNode 默认为 true 表示生成**后缀为 ReturnValueLocalNode** 的直接返回需求数据类型的 API 封装类型。
``` csharp
        /// <summary>
