...
module AutoCSer {
    export class MouseMenu extends Menu implements IDeclare {
        ...
        constructor(Parameter) {
            super(Parameter);
            Pub.GetParameterEvents(this, MouseMenu.DefaultParameter, MouseMenu.DefaultEvents, Parameter);
    ...
    Declare.Create(MouseMenu, 'MouseMenu', 'mouseover', DeclareType.ParameterId);
}