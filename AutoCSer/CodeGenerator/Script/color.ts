...
module AutoCSer {
    export class Color512_64 {
        ...
        constructor(Parameter) {
            Pub.GetParameterEvents(this, Color512_64.DefaultParameter, Color512_64.DefaultEvents, Parameter);
            this.Identity = Pub.GetIdentity();
            this.Image = Pub.JsDomain + '__JAVASCRIPTPATH__/color512_64.bmp';
        }
        Start() {
