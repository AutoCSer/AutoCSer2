...
(function (AutoCSer) {
    var OverDiv = /** @class */ (function () {
        function OverDiv(Parameter) {
            ...
            this.Id = '_' + AutoCSer.Pub.GetIdentity() + '_OVER_';
            this.Ids = [];
        }
        OverDiv.prototype.Show = function (Id, ZIndex) {
            ...
            if (Element.Element0())
                ...
                AutoCSer.HtmlElement.$Create('div').Style('zIndex', OverDiv.OverZIndex).Style('position', 'fixed').Styles('top,left', '0px').Styles('width,height', '100%').Style('backgroundColor', this.Color).Opacity(this.Opacity).Set('id', this.Id).To();
        };
...
//# sourceMappingURL=overDiv.js.map