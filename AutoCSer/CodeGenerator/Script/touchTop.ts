...
module AutoCSer {
    ...
    export class TouchTop extends TouchTopParameter {
        ...
        constructor(Parameter: TouchTopParameter = null) {
            super();
            Pub.GetParameterEvents(this, TouchTop.DefaultParameter, TouchTop.DefaultEvents, Parameter);
        ...
        private Start(Event: BrowserEvent) {
            this.Cancel();
            this.Step = 1;
            this.StartTop = this.EndTop = (Event.Event as TouchEvent).touches[0].pageY;
        }
        private Move(Event: BrowserEvent) {
            if (this.Step == 1) this.Step = 2;
            if (this.Step == 2) {
                this.EndTop = (Event.Event as TouchEvent).touches[0].pageY;
                this.Check();
            }
        }
        private Check() {
        ...
        private End(Event: BrowserEvent) {
            if (this.Step == 2) {
                this.EndTop = (Event.Event as TouchEvent).changedTouches[0].pageY;
