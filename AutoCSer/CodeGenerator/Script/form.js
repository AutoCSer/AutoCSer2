...
(function (AutoCSer) {
    var Form = /** @class */ (function () {
        function Form(Parameter) {
            AutoCSer.Pub.GetParameterEvents(this, Form.DefaultParameter, Form.DefaultEvents, Parameter);
        }
        ...
        Form.prototype.KeyDown = function (Event) {
            var Key = Event.Event.shiftKey || Event.KeyCode, Element = Event.Element, Type = Form.ElementType(Element), Next;
        ...
        Form.prototype.Format = function (Event) {
            var Element = Event.Element, FormElement = this.Elements[Element.name], Type = Form.ElementType(Element);
            if (Type == 1 || Type == 4)
        ...
        Form.prototype.Focus = function (Event) {
            var Element = Event.Element, FormElement = this.Elements[Element.name];
