...
module AutoCSer {
    export class VerifyImage implements IDeclare {
        ...
        constructor(Parameter) {
            Pub.GetParameterEvents(this, VerifyImage.DefaultParameter, VerifyImage.DefaultEvents, Parameter);
    ...
    Declare.Create(VerifyImage, 'VerifyImage', 'mouseover', DeclareType.ParentName);
}