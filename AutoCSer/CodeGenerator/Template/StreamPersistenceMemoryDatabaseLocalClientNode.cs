...
namespace AutoCSer.CodeGenerator.Template
{
    internal sealed class StreamPersistenceMemoryDatabaseLocalClientNode : Pub
    {
        ...
        /// </summary>
        public sealed partial class @ReturnValueNodeTypeName : AutoCSer.CommandService.StreamPersistenceMemoryDatabase.LocalClientReturnValueNode<@ClientNodeTypeName>
        {
            /// <summary>
            /// Get the direct return value API encapsulation (@CurrentType.XmlFullName)
            /// </summary>
