...
namespace AutoCSer
{
    ...
    public sealed class FifoPriorityQueue<KT, VT> where KT : IEquatable<KT>
    {
        ...
        /// 数据集合
        /// </summary>
        private ReusableDictionary<KT, Node> dictionary;
        /// <summary>
        /// 获取所有关键字
        /// </summary>
        ...
        public IEnumerable<KeyValue<KT, VT>> KeyValues
        {
            get
            {
                for (Node node = header; node != null; node = node.Next) yield return new KeyValue<KT, VT>(node.Key, node.Value);
            }
        }
        /// <summary>
        /// 数据数量
        ...
        public VT this[KT key]
        {
            get
            {
                ...
                return node != null ? node.Value : default(VT);
            }
        ...
        {
            dictionary = ReusableDictionary<KT>.Create<Node>(dictionaryCapacity, isClear);
        }
        /// <summary>
        ...
        /// <returns>数据对象</returns>
        [MethodImpl(AutoCSer.MethodImpl.AggressiveInlining)]
        public VT Get(ref KT key, VT nullValue)
        {
            Node node = getNode(ref key);
        ...
        /// <param name="key">键值</param>
        /// <returns>数据对象</returns>
        private Node getNode(ref KT key)
        {
            Node node;
        ...
        public VT Set(ref KT key, VT value)
        {
            Node node = getNode(ref key);
            if (node != null)
            {
        ...
        /// <param name="value"></param>
        [MethodImpl(AutoCSer.MethodImpl.AggressiveInlining)]
        internal void UnsafeAdd(ref KT key, VT value)
        {
