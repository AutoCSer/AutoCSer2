...
namespace AutoCSer.ObjectRoot
{
    ...
    public abstract class ObjectType
    {
        ...
        //    CatchTask.AddIgnoreException(AutoCSer.LogHelper.Add(LogLevel.Debug, $"类型不匹配 {type.GetType().FullName} <> {runtimeType.FullName}", true));
        //    return true;
        //}
        //static ObjectType()
        //{
