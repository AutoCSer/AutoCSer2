...
namespace AutoCSer.Net.Packet
{
    ...
    public struct Arp
    {
        ...
        {
            get { return new SubArray<byte>(data.Start + 8, 6, data.Array); }
        }
        /// <summary>
        /// 发送者的IP地址
        /// </summary>
        public uint SendIp
        {
            get { return BitConverter.ToUInt32(data.Array, data.Start + 14); }
        }
        /// <summary>
        /// 目的以太网地址
        /// </summary>
        ...
        {
            get { return new SubArray<byte>(data.Start + 18, 6, data.Array); }
        }
        /// <summary>
        /// 目的IP(查询MAC地址的IP)
        /// </summary>
        ...
        {
            get { return BitConverter.ToUInt32(data.Array, data.Start + 24); }
        }
        /// <summary>
        /// ARP数据包
        /// </summary>
