...
namespace AutoCSer.Extensions.Threading
{
    ...
    public sealed class EnumerableTask<T>
    {
        /// <summary>
        /// 获取任务参数集合
        /// </summary>
        ...
        /// 获取任务委托
        /// </summary>
        private readonly Func<T, Task> getTask;
        /// <summary>
        /// 任务并发锁
        /// </summary>
        ...
        internal EnumerableTask(IEnumerable<T> source, int taskCount, Func<T, Task> getTask)
        {
        ...
        /// </summary>
        /// <returns></returns>
        internal async Task<EnumerableTask<T>> Start()
        {
            bool isRun = true;
            taskCount = 1;
            try
