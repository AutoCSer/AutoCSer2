...
namespace AutoCSer.Search.WordCountIndexs
{
    ...
    public struct SearchResult<T> where T : IEquatable<T>
    {
        ...
        /// 搜索结果数量与单字符搜索结果
        /// </summary>
        public SearchCharResult<T, WordCounter<T>> CharResult { get { return new SearchCharResult<T, WordCounter<T>>(context, version); } }
        /// <summary>
        /// 搜索结果
        /// </summary>
        ...
        public bool GetWordResults(out LeftArray<KeyValue<SubString, WordCounter<T>>> results)
        {
