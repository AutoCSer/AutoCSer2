...
namespace AutoCSer.Metadata
{
    ...
    /// 泛型类型元数据
    /// </summary>
    internal abstract class GenericType2 : GenericTypeCache2<GenericType2>
    {
        /// <summary>
        /// JSON 键值对序列化委托
        /// </summary>
        internal abstract Delegate JsonSerializeKeyValuePairDelegate { get; }
        /// <summary>
        /// JSON 键值对序列化委托
        /// </summary>
        internal abstract Delegate JsonDeserializeKeyValuePairDelegate { get; }
    ...
    internal sealed class GenericType2<T1, T2> : GenericType2
    {
        ...
        /// JSON 键值对序列化委托
        /// </summary>
        internal override Delegate JsonSerializeKeyValuePairDelegate { get { return (Action<JsonSerializer, KeyValuePair<T1, T2>>)JsonSerializer.KeyValuePair<T1, T2>; } }
        /// <summary>
        /// JSON 键值对序列化委托
        /// </summary>
        internal override Delegate JsonDeserializeKeyValuePairDelegate { get { return (JsonDeserializer.DeserializeDelegate<KeyValuePair<T1, T2>>)JsonDeserializer.KeyValuePair<T1, T2>; } }
    }
}