...
namespace AutoCSer.StateSearcher
{
    ...
    internal unsafe struct CharSearcher
    {
        /// <summary>
        /// 状态集合
        /// </summary>
...
#if DEBUG
            if (charEnd < charStart) throw new Exception("charEnd < charStart");
#endif
        ...
        {
            if (state == null || string.IsNullOrEmpty(value)) return -1;
        ...
        /// <returns>状态索引,失败返回-1</returns>
        internal int UnsafeSearch(char* start, char* end)
        {
        ...
        /// <returns>状态索引,失败返回-1</returns>
        [MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        internal int UnsafeSearch(char* start, int length)
        {
