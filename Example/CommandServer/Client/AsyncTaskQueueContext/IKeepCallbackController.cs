...
{
    /// <summary>
    /// 服务端 async Task 读写队列调用上下文 保持回调委托返回数据 示例接口（客户端）
    /// </summary>
    public interface IKeepCallbackController
    {
        ...
        /// <param name="parameter2">参数</param>
        /// <returns></returns>
        [AutoCSer.Net.CommandClientMethod(MatchMethodName = nameof(Server.AsyncTaskQueueContext.IKeepCallbackController.CallbackReturn))]
        ...
        /// <param name="parameter">参数</param>
        /// <returns></returns>
        [AutoCSer.Net.CommandClientMethod(MatchMethodName = nameof(Server.AsyncTaskQueueContext.IKeepCallbackController.CallbackCall))]
        ...
        /// <param name="parameter2">参数</param>
        /// <returns></returns>
        [AutoCSer.Net.CommandClientMethod(MatchMethodName = nameof(Server.AsyncTaskQueueContext.IKeepCallbackController.CallbackCountReturn))]
        ...
        /// <param name="parameter">参数</param>
        /// <returns></returns>
        [AutoCSer.Net.CommandClientMethod(MatchMethodName = nameof(Server.AsyncTaskQueueContext.IKeepCallbackController.CallbackCountCall))]
        ...
        /// <param name="parameter2">参数</param>
        /// <returns></returns>
        [AutoCSer.Net.CommandClientMethod(MatchMethodName = nameof(Server.AsyncTaskQueueContext.IKeepCallbackController.EnumerableCallbackCount))]
        ...
        /// <param name="parameter2">参数</param>
        /// <returns></returns>
        [AutoCSer.Net.CommandClientMethod(MatchMethodName = nameof(Server.AsyncTaskQueueContext.IKeepCallbackController.AsyncEnumerable))]
