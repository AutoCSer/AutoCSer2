...
{
    /// <summary>
    /// 服务端 同步队列线程调用 保持回调委托返回数据 示例接口（客户端）
    /// </summary>
    public interface IKeepCallbackController
    {
        ...
        /// <param name="parameter2">参数</param>
        /// <returns></returns>
        [AutoCSer.Net.CommandClientMethod(MatchMethodName = nameof(Server.Queue.IKeepCallbackController.CallbackReturn))]
        ...
        /// <param name="parameter">参数</param>
        /// <returns></returns>
        [AutoCSer.Net.CommandClientMethod(MatchMethodName = nameof(Server.Queue.IKeepCallbackController.CallbackCall))]
        ...
        /// <param name="parameter2">参数</param>
        /// <returns></returns>
        [AutoCSer.Net.CommandClientMethod(MatchMethodName = nameof(Server.Queue.IKeepCallbackController.CallbackCountReturn))]
        ...
        /// <param name="parameter">参数</param>
        /// <returns></returns>
        [AutoCSer.Net.CommandClientMethod(MatchMethodName = nameof(Server.Queue.IKeepCallbackController.CallbackCountCall))]
