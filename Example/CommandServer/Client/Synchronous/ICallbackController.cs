...
{
    /// <summary>
    /// 服务端 IO线程同步调用 回调委托返回数据 示例接口（客户端）
    /// </summary>
    public interface ICallbackController
    {
        ...
        /// <returns></returns>
        [AutoCSer.Net.CommandClientMethod(MatchMethodName = nameof(Server.Synchronous.ICallbackController.CallbackReturn))]
        ...
        /// <param name="parameter2">参数</param>
        /// <returns></returns>
        [AutoCSer.Net.CommandClientMethod(MatchMethodName = nameof(Server.Synchronous.ICallbackController.CallbackCall))]
