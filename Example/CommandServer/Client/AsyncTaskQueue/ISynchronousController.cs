...
{
    /// <summary>
    /// 服务端控制器 async Task 读写队列调用 同步返回数据 示例接口（客户端）
    /// </summary>
    public interface ISynchronousController
    {
        ...
        /// <returns></returns>
        [AutoCSer.Net.CommandClientMethod(MatchMethodName = nameof(Server.AsyncTaskQueue.ISynchronousController.SynchronousReturn))]
        ...
        /// <param name="parameter2">参数</param>
        /// <returns></returns>
        [AutoCSer.Net.CommandClientMethod(MatchMethodName = nameof(Server.AsyncTaskQueue.ISynchronousController.SynchronousCall))]
