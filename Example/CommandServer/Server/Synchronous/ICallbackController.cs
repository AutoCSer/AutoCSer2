...
namespace AutoCSer.Example.CommandServer.Server.Synchronous
{
    ...
    public interface ICallbackController
    {
        ...
        void CallbackReturn(CommandServerSocket socket, int parameter1, int parameter2, CommandServerCallback<int> callback);
        /// <summary>
        ...
        /// <param name="parameter2">参数</param>
        /// <param name="callback">回调委托包装，必须是最后一个参数</param>
        void CallbackCall(int parameter1, int parameter2, CommandServerCallback callback);
    }
    /// <summary>
    /// 服务端 IO线程同步调用 回调委托返回数据 示例接口实例
    /// </summary>
    internal sealed class CallbackController : ICallbackController
    {
        ...
        /// <param name="parameter2">参数</param>
        /// <param name="callback">回调委托包装，必须是最后一个参数</param>
        void ICallbackController.CallbackReturn(CommandServerSocket socket, int parameter1, int parameter2, CommandServerCallback<int> callback)
        {
        ...
        /// <param name="parameter2">参数</param>
        /// <param name="callback">回调委托包装，必须是最后一个参数</param>
        void ICallbackController.CallbackCall(int parameter1, int parameter2, CommandServerCallback callback)
        {
